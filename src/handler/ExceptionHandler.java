...
public class ExceptionHandler {
    ...
    /**
     * Handler to handle situation when user attempts to access outside index of an array
     ...
     * @return  {@code true} if the index is within the array, {@code false} otherwise
     */
