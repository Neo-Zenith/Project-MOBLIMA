...
/**
 * Controller for handling all logic related to Payments
 * 
 * @author Ci Hui
 * @version 1.0
 */
...
public class PaymentManager {
     ...
     * 
     * @param transactionID     is the transaction ID of Payment generated when payment is made by Movie Goer
     * @param movieTicketPrice  is the total price of the Movie Tickets booked by Movie Goer
    ...
    /**
     * Method to create a {@link Payment} instance with Payment Type of Bank Transaction
     * and save to database
     * 
     * @param transactionID     is the transaction ID of Payment generated when payment is made by Movie Goer
     * @param movieTicketPrice  is the total price of the Movie Tickets booked by Movie Goer
     ...
     * @param showingTime   is the {@link DateTime} of Showing Time of the Movie chosen by the Movie Goer
     ...
     * (XXX: Cinema Code in letters, YYYY: year, MM: month, DD: day, hh: hour, mm: minutes)
     * 
     ...
     * 
     * @param showingTime   is the {@link DateTime} of the Showing Time of the Movie chosen by the Movie Goer
