...
/**
 * Controller for handling all logic related to Movie Tickets
 * 
 * @author Ci Hui
 * @version 1.0
 */
...
public class MovieTicketManager {
     ...
     * 
     * @param seatID                    is the Array List of front-end displayed Seat ID booked by the Movie Goer
     * @param movieToWatch              is the {@link Movie} chosen by the Movie Goer
     * @param showTime                  is the {@link DateTime} of the Showing Time of the Movie chosen by the Movie Goer
     * @param cinema                    is the {@link Cinema} chosen by the Movie Goer
     * @param seatingPlan               is the seating plan of the chosen Cinema
     * @param totalMovieTicketPrice     is the Total Price of the Movie Tickets booked by the Movie Goer
