...
public class MovieTicketManager {
    ...
    public static MovieTicket createMovieTicket(Movie movieToWatch, DateTime showTime, Seat bookedSeat, Cinema cinema,
        ...
        MovieTicket movieTicket = new MovieTicket(UUID, movieToWatch, showTime, bookedSeat, cinema, seatID);
    ...
    public static ArrayList<MovieTicket> createMovieTicketList(ArrayList<String> seatID, Movie movieToWatch,
        ...
        // create a new list of movie tickets based on the number of seatID got from
        // user
