...
/**
 * Controller for handling all logic related to booking histories
 * @author Lee Juin
 * @version 1.0
 */
public class BookingHistoryManager {
     ...
     * @param movieTicket is all the {@link MovieTicket} bought in a single {@link Payment}
     * @param payment is the {@link Payment} made in relation to the tickets bought
