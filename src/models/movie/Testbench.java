...
public class Testbench {
    ...
    public static void TestMovie() {
        ...
        movie2.setMoviePrice(5, 3, false);

        Movie movie3 = movieFactory.createMovie("Avenger", "ThreeD",
                MovieAgeRating.G, MovieShowingStatus.NOW_SHOWING,
                cast, "Rabbit", "So good", 50.6, dateList);
        movie3.setMoviePrice(5, 3, true);
        movie3.movieTicketSold();
        movie3.movieTicketSold();
        movie2.movieTicketSold();
        movie2.movieTicketSold();
        movie2.movieTicketSold();
        ...
        // customer.buyTicket();
        customer.setUserMovieReview("Avenger", "Blockbuster", "This is such a good movie!", 10);
        customer.setUserMovieReview("Avenger","ThreeD", "Disney movie is the best!", 9);
        customer.setUserMovieReview("Zootopia", "Blockbuster", "Movie not nice!", 5);
        
        movie3.printMovies();
        ArrayList<MovieReview> reviews = new ArrayList<MovieReview>();
        reviews = movie2.getMovieReviews();
        MovieReview review;
        for (int i = 0; i < reviews.size(); i++) {
            review = reviews.get(i);
            System.out.println(review.getReview());
        }
        System.out.println(movie2.getMovieOverallReviewRating());
